...
def train(train_loader, test_loader, class_name):
    ...
    for epoch in range(c.meta_epochs):
        ...
        print(f"Epoch {epoch} completed in: {format_time(epoch_duration)}")  # Print epoch duration
    ...
    if c.save_model:
        model.to('cpu')
        save_model(model, f"{class_name}_model")  #  class_name to model name
        save_weights(model, f"{class_name}_weights")  # class_name to weights name
    return model